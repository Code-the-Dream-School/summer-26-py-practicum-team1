...
|---|---|---|---|---|---|
| location | Location associated with the observation | string | city, country_code, state | Created from the original location context | Yes |
...
| observed_at | Date and time when the air-quality observation was recorded | datetime | ISO 8610 UTC | list[].dt converted from Unix seconds to UTC datetime | Yes |
